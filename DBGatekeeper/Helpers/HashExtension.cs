...
namespace DBGatekeeper.Helpers
{
    ...
    public static class HashExtension
    {
        ...
        public static string GetMACTripleDESHash(this object instance, string sKey)
        {
            byte[] binary = Encoding.UTF8.GetBytes(sKey);
            return instance.GetKeyedHash<MACTripleDES>(binary);
        }
